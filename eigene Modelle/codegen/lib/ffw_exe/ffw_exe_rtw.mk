...
## Generated on : Mon Feb 24 21:35:41 2020
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/Philip/Desktop/HiWi/eigene\ Modelle/codegen/lib/ffw_exe
ARCH                      = maci64
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I/Users/Philip/Desktop/HiWi/eigene\ Modelle -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
SRCS = $(START_DIR)/ffw_exe_initialize.c $(START_DIR)/ffw_exe_terminate.c $(START_DIR)/ffw_exe.c $(START_DIR)/MKS_4dof_jacobi.c $(START_DIR)/MKS_4dof_ffw.c $(START_DIR)/rt_nonfinite.c $(START_DIR)/rtGetNaN.c $(START_DIR)/rtGetInf.c
...
OBJS = ffw_exe_initialize.o ffw_exe_terminate.o ffw_exe.o MKS_4dof_jacobi.o MKS_4dof_ffw.o rt_nonfinite.o rtGetNaN.o rtGetInf.o
...
%.o : /Users/Philip/Desktop/HiWi/eigene\ Modelle/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : /Users/Philip/Desktop/HiWi/eigene\ Modelle/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
